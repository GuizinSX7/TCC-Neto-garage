...
class _CadastroveiculoState extends State<Cadastroveiculo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 20), // Adiciona espaçamento lateral
        child: Column(
          ...
          children: [
              ...
              child: Container(
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center, // Centraliza os ícones na linha
                      children: [
            ...
            // Botões de cores
            const SizedBox(height: 48), // Espaço entre o campo "Placa:" e os botões de cor
            Container(
              width: 304,
              height: 166,
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center, // Centraliza os botões de cores
                    children: [
